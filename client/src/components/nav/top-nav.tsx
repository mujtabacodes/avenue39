    ...
    <div className="bg-main text-secondary p-2 hidden md:block">
      <Container className="flex justify-between items-center gap-2">
        ...
        <div className="w-full lg:max-w-[58%] xl:max-w-[43%] 2xl:max-w-[40%] max-sm:pl-1 2xl:mr-6">
          <p className="flex justify-center gap-10 items-center font-medium text-12 2xl:text-13 xl:whitespace-nowrap">
        
            <FaRegMoon size={20} className="text-white relative top-[1px]" />
            <span>
            ...
            <GiLantern size={20} className="text-white relative top-[1px]" />
          </p>
        </div>
