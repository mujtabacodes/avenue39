  ...
  return (
    <div className="bg-main text-secondary p-2 hidden md:block ">
      <Container className="flex justify-between items-center gap-2">
        ...
        <div className="w-full lg:max-w-[58%] xl:max-w-[43%] 2xl:max-w-[40%] max-sm:pl-1 2xl:mr-6 relative z-[300]">
          <div className=" gap-2">   
          <Image className='absolute z-40 -left-40 -top-24 hidden xl:block ' src={ramadan2} alt='ramadan1'/>
            ...
            <Image className='absolute z-40 -right-40 2xl:-right-28 -top-24 hidden xl:block ' src={ramadan1} alt='ramadan1'/>
          </div>
        </div>
