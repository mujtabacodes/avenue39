  ...
  return (
    <div className="bg-main text-secondary p-2 hidden md:block ">
     ...
     <div className="max-lg:hidden lg:w-3/12 min-w-32">
        ...
        <p className='font-medium text-12 xl:text-14 pl-3 2xl:pl-5'>FALL CLEARANCE. SAVE UP TO 60% ON OUTDOOR, LIVING, DINING, BEDROOM & MORE. <Link className='text-red-600 border-b border-red-600' href={'products'} >SHOP SALE</Link></p>
        </div>
