...
const Navbar = (props: INav) => {
  ...
  <div className="relative rounded-md">
    <input type="text" className="py-4 px-4 pe-11 border block w-full text-sm disabled:opacity-50 " placeholder="Search Here..." />
    ...
    <div className='w-4/12 gap-4 flex justify-between items-center'>
      ...
      <div className='flex gap-8'>
        <Link className='gap-2 flex items-center text-14' href={"/"}><FaRegUser size={25} />Login/Register</Link>
        <Link className='text-14' href={"/"}>About us</Link>
        <Link className='text-14' href={"/"}>Contact Us</Link>
      </div>
    </div>
