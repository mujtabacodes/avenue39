...
import { tabbyfeature, tabbyhowitwork, tabbypayicon, tamarafeature, tamaralist, tamarawhy } from '@/data';
...
const ProductDetail = ({ params , isZoom }: { params: IProductDetail , isZoom?: Boolean }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full justify-between gap-4 my-10">
