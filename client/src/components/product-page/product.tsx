      ...
      <Container className="my-5 flex flex-col md:flex-row gap-4 md:gap-8">
        ...
        <div className="w-full">
          ...
          <div className="sm:mt-4 mt-10 flex items-center justify-between gap-4 py-2 px-2 flex-col md:flex-row">
            <div className="flex items-center gap-4">
              <p className="md:block hidden">
                Showing{' '}
                {!filterLoading && filteredCards.length > 0
          ...
          {filterLoading || isProductsLoading ? (
            ...
            <div
              className={`grid gap-4 mt-4 ${layout === 'grid' ? 'grid-cols-1 sm:grid-cols-2 xl:grid-cols-3' : 'grid-cols-1'}`}
            >
                  ...
                  <div key={card.id}>
                    {layout === 'grid' ? (
                      <Card
                        ...
                        category
                        isLoading={false}
                        cardImageHeight="h-[350px] xsm:h-[500px] sm:h-[400px] md:h-[350px] 2xl:h-[400px]"
                      />
                    ) : (
