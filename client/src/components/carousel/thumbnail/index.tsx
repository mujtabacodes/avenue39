...
const Thumbnail: React.FC<ThumbProps> = ({
    ...
    <div>
      <div className="relative w-full">
        <div className={`w-full flex gap-3 ${swiperGap} `}>
          <div className="w-3/12 md:w-1/5 2xl:w-1/5 lg:w-1/5 relative h-fit max-h-[300px] xs:max-h-[355px] sm:max-h-[550px] md:max-h-[400px] lg:max-h-[520px] xl:max-h-[420px] 2xl:max-h-[590px] 3xl:max-h-[650px] ">
            {loading ? (
            ...
            <div
  className="absolute bottom-0 right-0 md:right-auto md:left-1/2 transform md:translate-x-[-50%] z-10 cursor-pointer bg-[#F6F6F6] w-12 h-12 flex justify-center items-center"
  onClick={() => swiperImageRef.current?.slideNext()}
          ...
          <div
            className={`w-9/12 2xl:w-4/5 md:flex-grow relative border-2 border-gray-100 shadow rounded-lg md:!max-h-[700px] lg:!max-h-[570px] xl:!max-h-[637px] 2xl:!max-h-[750px] 3xl:!max-h-[650px]`}
          >
            {loading ? (
