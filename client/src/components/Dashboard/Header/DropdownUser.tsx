  ...
  return (
    <div className="relative z-50">
      ...
      {loggedInUser ? loggedInUser.fullname : null }
          ...
          <span className="block text-xs text-black ">{loggedInUser?.role}</span>
        </span>
      ...
      >
        ...
        <button className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base text-black " onClick={logoutHhandler}>
          <svg
            className="fill-current"
            width="22"
            height="22"
