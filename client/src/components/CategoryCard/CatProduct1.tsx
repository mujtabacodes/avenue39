...
const CatProduct1 = ({ reverse, CategoryName,products }: ICatProduct) => {
  return (
    ...
    <div className="absolute -top-7 xs:-top-5 left-1/2 transform -translate-x-1/2 min-w-[180px] rounded-xl border bg-white xs:left-20 xs:transform-none">
        ...
        <div className={`col-span-12 md:col-span-6 xl:col-span-7 `}>
          ...
          {products.length < 1 && (
             <ProductSkeleton imageHeight="h-[210px] xl:h-[496.5px]" />
              ...
              <ProductGrid products={products.slice(5, 6)} CardComponent={Card} slider={true} imageHeight="h-[210px] xl:h-[496.5px] w-full" portSpace={'px-10'} />
          </div>
        </div>
