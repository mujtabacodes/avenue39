...
const CatProduct1 = ({ reverse, CategoryName,products,redirect }: ICatProduct) => {
  ...
  return (
    ...
    <Link href={`/${redirect}`} className="absolute -top-7 xs:-top-5 left-1/2 transform -translate-x-1/2 min-w-[180px] rounded-xl border bg-white xs:left-20 xs:transform-none hover:hover:font-bold">
