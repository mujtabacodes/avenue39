...
const CatProduct = ({ reverse, CategoryName, products , landHeight ,portSpace , sofaHeight ,sideTableHeight }: ICatProduct) => {
  console.log("Products array: ", products);

  return (
    <Container className="my-10">
      <div className='relative px-2 md:px-6 border-2 border-[#707070] rounded-[87px]'>
        ...
        <div className={`mt-12 flex ${reverse ? 'flex-col-reverse' : 'flex-col'}`}>
