            ...
            <div className="bg-lightforeground rounded-r-2xl flex flex-wrap items-center ps-5 xs:px-10 sm:ps-20 2xl:ps-32 min-h-[530px] 2xl:h-[740px]">
              ...
              <div className="w-full xs:w-1/3 max-xs:text-center">
                ...
                <Link href={slide.link}
                      className="py-1 px-3 bg-white text-base md:text-2xl lg:text-sm xl:text-xl 2xl:text-3xl rounded-full text-black border border-gray-500 hover:bg-main font-Helveticalight" >
                     Shop Best Sellers
                    </Link>
