...
export const menuData: MenuData = {
  dining: [
    {categoryId: 3 , link: '/products', title: 'Dining Tables', icon: diningTable },
    {categoryId: 3 , link: '/products', title: 'Dining Chairs', icon: diningChair },
    {categoryId: 3 , link: '/products', title: 'Side Cabinets', icon: sideCabinets },
    {categoryId: 3 , link: '/products', title: 'Accessories', icon: accessories },
  ],
  living: [
  ...
  bedroom: [
    {categoryId: 5 , link: '/products', title: 'Table Lamps', icon: tableLamps },
    {categoryId: 5 , link: '/products', title: 'Bedside Tables', icon: bedsideTables },
    {categoryId: 5 , link: '/products', title: 'TV Cabinets', icon: tvCabinets },
    {categoryId: 5 , link: '/products', title: 'Sofa Beds', icon: sofaBed },
    {categoryId: 5 , link: '/products', title: 'Accessories', icon: accessories },

  ],
  chairs: [
    {categoryId: 6 , link: '/products', title: 'Armchairs', icon: armchair },
    {categoryId: 6 , link: '/products', title: 'Accent Chairs', icon: accentChairs },
    {categoryId: 6 , link: '/products', title: 'Sofas', icon: sofa },
    {categoryId: 6 , link: '/products', title: 'Dining Chairs', icon: diningChair },
    {categoryId: 6 , link: '/products', title: 'Barstools', icon: barstool },
  ],
  tables: [
    {categoryId: 7 , link: '/products', title: 'Dining Tables', icon: diningTable },
    {categoryId: 7 , link: '/products', title: 'Office Tables', icon: officeTables },
    {categoryId: 7 , link: '/products', title: 'Side Tables', icon: sideTable },
    {categoryId: 7 , link: '/products', title: 'Coffee Tables', icon: coffeeTables },
    {categoryId: 7 , link: '/products', title: 'Bedside Tables', icon: bedsideTables },
  ],
  homeOffice: [
    {categoryId: 8 , link: '/products', title: 'Office Tables', icon: officeTables },
    {categoryId: 8 , link: '/products', title: 'Office Chairs', icon: officeChair },
  ],
  Lighting: [
    {categoryId: 9 , link: '/products', title: 'Floor Lamps', icon: floorLamps },
    {categoryId: 9 , link: '/products', title: 'Table Lamps', icon: tableLamps },
  ],
