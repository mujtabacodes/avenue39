...
export default function Home() {
  ...
  useEffect(() => {
    AOS.init({
      ...
      once: false, // Allow animation to occur every time you scroll to the section
      offset: 150, // Adjust the offset for when the animation should trigger
      delay: 600, // Delay before animation starts (optional)
    });
  }, []);
  return (
    <Fragment>
